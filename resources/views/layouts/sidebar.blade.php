    ...
    <div class="modern-profile p-3 pb-0">
        <div class="text-center rounded bg-light p-3 mb-4 user-profile">
            <div class="avatar avatar-lg online mb-3">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->prenom . ' ' . Auth::user()->nom) }}&background=random" alt="Img"
                    class="img-fluid rounded-circle">
            </div>
            <h6 class="fs-12 fw-normal mb-1">{{ Auth::user()->prenom }} {{ Auth::user()->nom }}</h6>
                ...
                <li class="menu-title"><span>COMPTE</span></li>
                                <li>
                                    <a href="{{ route('recruitments.index') }}">
                                        <i class="ti ti-user-plus"></i><span>Recrutement</span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('trainings.index') }}">
                                        <i class="ti ti-book"></i><span>Formation</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('payments.index') }}">
                                        <i class="ti ti-cash"></i><span>Paiement</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('reports.index') }}">
                                        <i class="ti ti-report"></i><span>Rapport</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="ti ti-help"></i><span>Aide</span>
                                    </a>
                                </li>
                <li>
                    <a href="{{ route('logout') }}"
