        ...
        <form action="{{ route('employees.update', $employee) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" required>
                        ...
                        <option value="En congé" {{ old('status', $employee->status) == 'En congé' ? 'selected' : '' }}>En congé</option>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" id="salary" name="salary" class="form-control @error('salary') is-invalid @enderror" value="{{ old('salary', $employee->salary) }}">
